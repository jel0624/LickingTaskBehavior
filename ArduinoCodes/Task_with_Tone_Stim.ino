...
unsigned long RewardSizeLeft = 32;
unsigned long RewardSizeRight = 16;
...
int LaserStimProb = 20;//change for stim sessions!
unsigned long ISIlaser = 25;//Time of stim in (ms) after cue
...
unsigned long waitTime1 = 1300;
unsigned long waitTime2 = 0;
