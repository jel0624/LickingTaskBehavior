...
unsigned long RewardSizeLeft = 16;
unsigned long RewardSizeRight =10;
...
void loop()
{
  ...
  if (   (D1 > D2) && (state == D3) && (LaserStim == 0) && (D1 < 10000) && (LaserTrialType>66))
  {
    LaserStim = 1;
  ...
  if (   ((Dummy3 - Dummy2) > (ISIlaser)) && (state == 3) && (LaserStim == 0) && ((Dummy3 - Dummy2) < 10000) && (LaserTrialType<66) )
  {
    LaserStim = 1;
    if (random(100) < LaserStimProb)
    {
